...
export class JournalEntryPageMusiqueSheet extends foundry.applications.sheets.journal.JournalEntryPageHandlebarsSheet {
  /** @override */
  ...
  static EDIT_PARTS = {
    ...
    content: {
      template: "modules/musique-journal-page-type/templates/musique/edit.hbs",
  ...
  static VIEW_PARTS = {
    content: {
      template: "modules/musique-journal-page-type/templates/musique/view.hbs",
      root: true
    }
  };
  ...
  #createSourceInput(field, inputConfig) {
    return foundry.applications.elements.HTMLFilePickerElement.create({ type: "audio", ...inputConfig });
  }
}